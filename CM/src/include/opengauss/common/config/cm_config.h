...
#define CM_NODE_MAXNUM 9
#define CM_MAX_DATANODE_PER_NODE 9
#define CM_MAX_THREAD_NUM (165)
#define CM_MAX_INSTANCE_PER_NODE 9
...
#define CM_PRIMARY_STANDBY_NUM (9)  // supprot one primary and multi standby
#endif
...
extern ClusterType g_clusterType;
